...
Specifically targets Swift file duplicates in the Sources build phase
"""

import re
from pathlib import Path

def fix_swift_duplicates():
    """Fix Swift file duplicates in Sources build phase"""
    ...
    print("🔧 Fixing Swift file duplicates...")
    ...
    print(f"Found Sources build phase with {len(sources_content.split(','))} entries")
    
    # Find all Swift file references in Sources
    swift_files = {}
    ...
    print("✅ Swift duplicates fixed!")
    print("Now let's test the build...")

if __name__ == "__main__":
    fix_swift_duplicates()
