...
//  on brand
//
//  This is the main ProfileView that orchestrates all profile-related components.
//  It follows a modular approach where each section is broken into its own file
...
// This is the main container view that brings together all profile components
struct ProfileView: View {
    
    // MARK: - State Properties
    // These properties manage the internal state of the profile view
    ...
    // MARK: - Properties
    /// The user's primary style archetype (e.g., "Main Character", "Minimalist")
    ...
    // MARK: - Main Body
    // This is the main view that gets displayed to the user
    var body: some View {
        VStack(spacing: 0) {
    ...
    // MARK: - Helper Methods
    // These methods handle the business logic for the profile view
